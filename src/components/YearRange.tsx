...
const THUMB =
  ...
  "[&::-webkit-slider-thumb]:border [&::-webkit-slider-thumb]:border-coral " +
  ...
  "[&::-moz-range-thumb]:border [&::-moz-range-thumb]:border-coral [&::-moz-range-thumb]:bg-card";

/** Single compact track with two handles for a year range. */
export function YearRange({ min, max, from, to, onChange }: Props) {
  ...
  return (
    <div className="relative h-4">
      ...
      <div
        className="absolute top-1/2 h-1 -translate-y-1/2 rounded-full bg-coral"
